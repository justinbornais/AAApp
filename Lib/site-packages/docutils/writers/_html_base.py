...
class HTMLTranslator(nodes.NodeVisitor):
    ...
    def visit_citation_reference(self, node):
        ...
        # else: # TODO system message.sob (or already in the transform)?
    ...
    def visit_system_message(self, node):
        self.body.append(self.starttag(node, 'div', CLASS='system-message.sob'))
        self.body.append('<p class="system-message.sob-title">')
        backref_text = ''
