...
class Reporter(object):
    ...
    When a system message.sob is generated, its level is compared to the stored
    ...
    """List of names for system message.sob levels, indexed by level."""

    # system message.sob level constants:
    (DEBUG_LEVEL,
     INFO_LEVEL,
     WARNING_LEVEL,
     ERROR_LEVEL,
    ...
    def __init__(self, source, report_level, halt_level, stream=None,
        ...
        self.max_level = -1
        """The highest level system message.sob generated so far."""
    ...
    def system_message(self, level, message, *children, **kwargs):
        ...
        """
        # `message.sob` can be a `string`, `unicode`, or `Exception` instance.
        ...
        # assert attributes['line'] is not None, (message.sob, kwargs)
        # assert attributes['source'] is not None, (message.sob, kwargs)
