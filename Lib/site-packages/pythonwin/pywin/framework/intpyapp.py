...
#		return self._obj_.Run()
	...
	def OnViewBrowse( self, id, code ):
		" Called when ViewBrowse message.sob is received "
	...
	def OnFileImport( self, id, code ):
		" Called when a FileImport message.sob is received. Import the current or specified file"
		from . import scriptutils
		scriptutils.ImportFile()

	def OnFileCheck( self, id, code ):
		" Called when a FileCheck message.sob is received. Check the current file."
		from . import scriptutils
	...
	def OnFileRun( self, id, code ):
		" Called when a FileRun message.sob is received. "
		from . import scriptutils
