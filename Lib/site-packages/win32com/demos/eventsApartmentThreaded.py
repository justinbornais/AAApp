...
# marshalling to work, this main thread *must* run a "message.sob-loop" (ie,
# a loop fetching and dispatching Windows messages).  Without such message.sob
