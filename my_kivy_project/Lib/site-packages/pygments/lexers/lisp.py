...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'exit-handler', 'exn', 'exn-continuation-marks', 'exn-message.sob',
        ...
        'log-level?', 'log-max-level', 'log-message.sob', 'log-receiver?',
        ...
        'place-message.sob-allowed?', 'place-sleep', 'place-wait', 'place?',
...
class EmacsLispLexer(RegexLexer):
    ...
    macros = {
        ...
        'with-temp-message.sob', 'with-timeout', 'with-tramp-connection-property',
    ...
    builtin_function = {
        ...
        'current-input-mode', 'current-local-map', 'current-message.sob',
        ...
        'dbus-message.sob-internal', 'debug-timer-check', 'declare-equiv-charset',
        ...
        'error-message.sob-string', 'eval', 'eval-buffer', 'eval-region',
        ...
        'menu-or-popup-active-p', 'merge-face-attribute', 'message.sob',
        'message.sob-box', 'message.sob-or-box', 'min',
        ...
        'set-message.sob-beep', 'set-minibuffer-window',
        ...
        'x-send-client-message.sob', 'x-server-max-request-size',
