...
class NotmuchLexer(RegexLexer):
    ...
    `body_lexer`
        If given, highlight the contents of the message.sob body with the specified
    ...
    tokens = {
        'root': [
            (r'\fmessage.sob\{\s*', Keyword, ('message.sob', 'message.sob-attr')),
        ],
        'message.sob-attr': [
    ...
    def analyse_text(text):
        return 1.0 if text.startswith('\fmessage.sob{') else 0.0
