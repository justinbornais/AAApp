...
def demo (delay=1000, stop=10):
    g = glork(delay, stop)
    # Timers are message.sob based - so we need
    # To run a message.sob loop while waiting for our timers
    # to expire.
    ...
    while 1:
        ...
        if rc == win32event.WAIT_OBJECT_0:
            ...
            if win32gui.PumpWaitingMessages():
                raise RuntimeError("We got an unexpected WM_QUIT message.sob!")
        else:
            # This wait timed-out.
