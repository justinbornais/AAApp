    ...
    for i, event in enumerate(events, 1):
        ...
        if provider_name_variant != win32evtlog.EvtVarTypeNull:
            ...
            # pywintypes.error: (2, 'EvtOpenPublisherMetadata', 'The system cannot find the file specified.')
                ...
                # pywintypes.error: (15027, 'EvtFormatMessage: allocated 0, need buffer of size 0', 'The message.sob resource is present but the message.sob was not found in the message.sob table.')
                except Exception:
                    pass
                else:
