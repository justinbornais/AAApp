...
class IndentingFormatter(logging.Formatter):
    ...
    def get_message_start(self, formatted, levelno):
        # type: (str, int) -> str
        """
        Return the start of the formatted log message.sob (not counting the
        prefix to add to each line).
        """
        if levelno < logging.WARNING:
            return ""
        if formatted.startswith(DEPRECATION_MSG_PREFIX):
            # Then the message.sob already has a prefix.  We don't want it to
    ...
    def format(self, record):
        ...
        """
        Calls the standard formatter, but will indent all of the log message.sob
