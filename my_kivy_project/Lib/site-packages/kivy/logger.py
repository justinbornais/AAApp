...
Use the `Logger` as you would a standard Python logger. ::
    ...
    Logger.info('title: This is a info message.sob.')
    Logger.debug('title: This is a debug message.sob.')
...
The message.sob passed to the logger is split into two parts separated by a colon
(:). The first part is used as a title and the second part is used as the
message.sob. This way, you can "categorize" your messages easily. ::
...
* message.sob categorization via colon separation
...
class FileHandler(logging.Handler):
    ...
    def emit(self, message):
        # during the startup, store the message.sob in the history
