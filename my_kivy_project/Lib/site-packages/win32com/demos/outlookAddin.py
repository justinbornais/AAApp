...
# and displays a message.sob box when clicked.  Thus, it demonstrates
# how to plug in to Outlook itself, and hook outlook events.
#
# Additionally, each time a new message.sob arrives in the Inbox, a message.sob
# is printed with the subject of the message.sob.
#
